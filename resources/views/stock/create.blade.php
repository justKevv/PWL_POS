        ...
        <div class="card-body">
            <form method="POST" action="{{ url('/stock') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="date" class="form-control" id="date_stock" name="date_stock" value="{{
                            old('date_stock', date('Y-m-d')) }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="text" class="form-control" id="stock_quantity" name="stock_quantity" value="{{
        old('stock_quantity') }}" required>
